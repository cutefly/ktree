...
public class ResultProjectScore {
	...
	public void setProjectScore(int seq, String month, float score1, float score2, float score3, float score4,
			float score5, float score6, float score7, float score8, int status, String dissent, String comments1,
